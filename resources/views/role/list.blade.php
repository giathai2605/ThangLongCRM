...
<div class="d-flex justify-content-between layout-top-spacing mt-md-5 px-5">
    <h4 class="">Danh sách chức vụ</h4>
    <a class="btn btn-outline-warning" href="{{ route('role.add') }}">+ Thêm mới</a>
</div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <ul class="table-controls ">
                            <li><a href="{{route('role.edit',['id'=>$item->id])}}" class="bs-tooltip"
                            ...
                            <li><a href="{{route('role.delete',['id'=>$item->id])}}" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="bs-tooltip"
                                    data-bs-toggle="tooltip" data-bs-placement="top"
