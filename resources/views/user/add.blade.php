...
@section('content')
    <div class="layout-top-spacing px-4">
        <h4 class="fs-4 fw-bold">Tạo mới nhân viên</h4>
    </div>

    <form class="row g-3 px-4 mt-md-3" method="post" action="{{route('user.add')}}" enctype="multipart/form-data">
        @csrf
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" name="phone" value="{{old('phone')}}" placeholder="+84 123-4567">
            @error('phone')
            <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            <div class="row">
                ...
                <div class="col-md-3">
                 <img width="80" height="50" src="https://png.pngtree.com/element_our/png/20181206/users-vector-icon-png_260862.jpg" alt="" class="img-fluid" id="image_preview">
                </div>
             </div>
             @error('avatar')
                <small class="text-danger">{{$message}}</small>
        ...
        <div class="col-md-6">
            ...
            <input type="password" class="form-control" value="{{old('re-password')}}" name="re-password" placeholder="********">
            @error('re-password')
            <small class="text-danger">{{$message}}</small>
            @enderror
        </div>
