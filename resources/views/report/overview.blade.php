    ...
    <div class="layout-px-spacing">
        <div class="middle-content container-xxl p-0">
            ...
            <div class="action-btn layout-top-spacing mb-5">
                <button id="add-list" class="btn btn-secondary">Tạo báo cáo</button>
            </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="task-badge d-flex">
                                                                    ...
                                                                    <input type="file" name="fileData" id="" class="form-control">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
                                            ...
                                            <div class="col-md-12">
                                                <div class="list-title d-flex">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                        ...
                                                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                        class="feather feather-list me-3 align-self-center">
                                                    ...
                                                    <input id="s-list-name" type="text" placeholder="Tiêu đề..."
                        ...
                        <div data-section="s-new" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="">Phòng công nghệ</h6>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right left"
                                ...
                                <div class="connect-sorting-content" data-sortable="true">
                                    ...
                                    <div data-draggable="true" class="card img-task">
                                        <div class="card-body">
                                            ...
                                            <div class="task-content">
                                                <img src="../../build/assets/taskboard.ece669ea.jpg" class="img-fluid"
                                                    alt="scrumboard">
                                            </div>
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class=""
                                                        ...
                                                        Creating a new Portfolio on Dribble</h4>
                                                </div>
                                            </div>
                                    ...
                                    <div data-draggable="true" class="card simple-title-task">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Singapore Team Meet">Singapore
                                                        Team Meet</h4>
                                                </div>
                                                <div class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <div class="connect-sorting-content" data-sortable="true">
                                    <div data-draggable="true" class="card simple-title-task ui-sortable-handle">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-tasktitle="Dinner with Kelly Young">Dinner
                                                        with Kelly Young</h4>
                                                </div>
                                                <div class="">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    ...
                                                    <div class="">
                                                        <div class="progress br-30">
                                                            <div class="progress-bar bg-success" role="progressbar"
                                                                data-progressState="20" style="width: 20%"
